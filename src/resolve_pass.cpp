...
//
//			for (uint i = 0; i < pExpr->apParamVarDecls.cItem; i++)
//			{
//				doResolvePass(pPass, pExpr->apParamVarDecls[i]);
//			}
//
//			for (uint i = 0; i < pExpr->apReturnVarDecls.cItem; i++)
//			{
...
//			// Resolve params
//
//			for (uint i = 0; i < pStmt->apParamVarDecls.cItem; i++)
//			{
...
//
//			for (uint i = 0; i < pStmt->apReturnVarDecls.cItem; i++)
//			{
